...
(function() {
  var DEFAULT_COLLECTION, Migrator, Promise, _, defaultLog, fs, migrationStub, mkdirp, mongoConnect, path, repeatString,
    slice = [].slice;
  ...
  Migrator = (function() {
    function Migrator(dbConfig, logFn) {
      ...
      this._collName = dbConfig.collection || DEFAULT_COLLECTION;
