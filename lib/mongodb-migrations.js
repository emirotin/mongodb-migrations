  ...
  Migrator = (function() {
    ...
    Migrator.prototype._run = function(direction, done, progress) {
      ...
      runOne = (function(_this) {
        return function() {
          var context, fn, resultFn, id, isCallbackCalled, migration, migrationDone, skipCode, skipReason, timeoutId, checkCallDone = false;
          if (i >= l) {
            return allDone();
          }
          migration = m[i];
          ...
          resultFn = fn.call(context, function(err) {
            checkCallDone = true;
            if (isCallbackCalled) {
              return;
            }
